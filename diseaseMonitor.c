...
int main(int argc, char* argv[]){
    ...
    diseaseHashtableNumOfEntries=50;       //default times an den dothoun orismata
    countryHashtableNumOfEntries=100;
    bucketSize=124;
    ...
    if (bucketSize<56){
        printf("Bucket size is too small, changed to 56 bytes\n");
        bucketSize=56;
    }
